...
namespace capaDatos.Database
{
    ...
    public partial class TM_Usuario : INotifyPropertyChanging, INotifyPropertyChanged
    {
        ...
        private System.Nullable<System.DateTime> _fechaModificado;
        ...
        partial void OnfechaCreadoChanging(System.Nullable<System.DateTime> value);
        partial void OnfechaCreadoChanged();
        partial void OnfechaModificadoChanging(System.Nullable<System.DateTime> value);
        ...
        [global::System.Data.Linq.Mapping.ColumnAttribute(Storage = "_creadoPor", DbType = "NVarChar(25)")]
        ...
        [global::System.Data.Linq.Mapping.ColumnAttribute(Storage = "_modificadoPor", DbType = "NVarChar(25)")]
        ...
        [global::System.Data.Linq.Mapping.ColumnAttribute(Storage = "_canceladoPor", DbType = "NVarChar(25)")]
        ...
        [global::System.Data.Linq.Mapping.ColumnAttribute(Storage = "_fechaModificado", DbType = "Date")]
        ...
        [global::System.Data.Linq.Mapping.ColumnAttribute(Storage = "_fechaCancelado", DbType = "Date")]
        ...
        [global::System.Data.Linq.Mapping.AssociationAttribute(Name = "TM_Usuario_TD_Login", Storage = "_TD_Logins", ThisKey = "Usuario_ID", OtherKey = "Usuario_ID")]
        ...
        [global::System.Data.Linq.Mapping.AssociationAttribute(Name = "TM_Usuario_TD_RolesxUsuario", Storage = "_TD_RolesxUsuarios", ThisKey = "Usuario_ID", OtherKey = "Usuario_ID")]
    ...
    public partial class TD_Login : INotifyPropertyChanging, INotifyPropertyChanged
    {
        ...
        [global::System.Data.Linq.Mapping.AssociationAttribute(Name = "TM_Usuario_TD_Login", Storage = "_TM_Usuario", ThisKey = "Usuario_ID", OtherKey = "Usuario_ID", IsForeignKey = true)]
        public TM_Usuario TM_Usuario
        {
            get
            {
    ...
    [global::System.Data.Linq.Mapping.TableAttribute(Name = "dbo.TD_RolesxUsuarios")]
    public partial class TD_RolesxUsuario : INotifyPropertyChanging, INotifyPropertyChanged
    {

        private static PropertyChangingEventArgs emptyChangingEventArgs = new PropertyChangingEventArgs(String.Empty);

        private int _idRolxUsuario;
        ...
        partial void OnValidate(System.Data.Linq.ChangeAction action);
        partial void OnCreated();
        partial void OnidRolxUsuarioChanging(int value);
        ...
        [global::System.Data.Linq.Mapping.ColumnAttribute(Storage = "_idRolxUsuario", AutoSync = AutoSync.OnInsert, DbType = "Int NOT NULL IDENTITY", IsPrimaryKey = true, IsDbGenerated = true)]
        public int idRolxUsuario
        {
            get
            {
        ...
        [global::System.Data.Linq.Mapping.AssociationAttribute(Name = "TM_Usuario_TD_RolesxUsuario", Storage = "_TM_Usuario", ThisKey = "Usuario_ID", OtherKey = "Usuario_ID", IsForeignKey = true)]
        public TM_Usuario TM_Usuario
        {
            get
            {
        ...
        [global::System.Data.Linq.Mapping.AssociationAttribute(Name = "TM_Role_TD_RolesxUsuario", Storage = "_TM_Role", ThisKey = "idRol", OtherKey = "idRol", IsForeignKey = true)]
    ...
    public partial class TM_OperacionSistema : INotifyPropertyChanging, INotifyPropertyChanged
    {
        ...
        private int _OperacionSist_ID;

        private string _Operacion_URL;

        private string _DescripcionOp;
        ...
        partial void OnValidate(System.Data.Linq.ChangeAction action);
        partial void OnCreated();
        partial void OnOperacionSist_IDChanging(int value);
        partial void OnOperacionSist_IDChanged();
        partial void OnOperacion_URLChanging(string value);
        partial void OnOperacion_URLChanged();
        partial void OnDescripcionOpChanging(string value);
        partial void OnDescripcionOpChanged();
        partial void OnfechaCreadoChanging(System.Nullable<System.DateTime> value);
        partial void OnfechaCreadoChanged();
        partial void OnfechaModificadoChanging(System.Nullable<System.DateTime> value);
        partial void OnfechaModificadoChanged();
        ...
        [global::System.Data.Linq.Mapping.ColumnAttribute(Storage = "_OperacionSist_ID", AutoSync = AutoSync.OnInsert, DbType = "Int NOT NULL IDENTITY", IsPrimaryKey = true, IsDbGenerated = true)]
        public int OperacionSist_ID
        {
            get
            {
                return this._OperacionSist_ID;
            }
            set
            {
                if ((this._OperacionSist_ID != value))
                {
                    this.OnOperacionSist_IDChanging(value);
                    this.SendPropertyChanging();
                    this._OperacionSist_ID = value;
                    this.SendPropertyChanged("OperacionSist_ID");
                    this.OnOperacionSist_IDChanged();
                }
            }
        }

        [global::System.Data.Linq.Mapping.ColumnAttribute(Storage = "_Operacion_URL", DbType = "NVarChar(50)")]
        public string Operacion_URL
        {
            get
            {
                return this._Operacion_URL;
            }
            set
            {
                if ((this._Operacion_URL != value))
                {
                    this.OnOperacion_URLChanging(value);
                    this.SendPropertyChanging();
                    this._Operacion_URL = value;
                    this.SendPropertyChanged("Operacion_URL");
                    this.OnOperacion_URLChanged();
                }
            }
        }

        [global::System.Data.Linq.Mapping.ColumnAttribute(Storage = "_DescripcionOp", DbType = "NVarChar(MAX)")]
        public string DescripcionOp
        {
            get
            {
                return this._DescripcionOp;
            }
            set
            {
                if ((this._DescripcionOp != value))
                {
                    this.OnDescripcionOpChanging(value);
                    this.SendPropertyChanging();
                    this._DescripcionOp = value;
                    this.SendPropertyChanged("DescripcionOp");
                    this.OnDescripcionOpChanged();
                }
            }
        }
    ...
    public partial class TM_Role : INotifyPropertyChanging, INotifyPropertyChanged
    {
        ...
        [global::System.Data.Linq.Mapping.AssociationAttribute(Name = "TM_Role_TD_RolesxUsuario", Storage = "_TD_RolesxUsuarios", ThisKey = "idRol", OtherKey = "idRol")]
        public EntitySet<TD_RolesxUsuario> TD_RolesxUsuarios
        {
            get
            {
    ...
    public partial class vw_Usuario
    {
        ...
        [global::System.Data.Linq.Mapping.ColumnAttribute(Storage = "_nomUsuario", DbType = "VarChar(50)")]
